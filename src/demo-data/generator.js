...
const femaleFirstNames = ['Brazil','Colombia','Argentina','Peru', 'Venezuela'];
const maleFirstNames = ['New York', 'Los Angeles', 'Chicago', 'Las Vegas', 'Austin', 'Tokyo', 'Rio de Janeiro', 'London', 'Paris'];
const lastNames = [
    'New York', 'Los Angeles', 'Chicago', 'Las Vegas', 'Austin', 'Tokyo', 'Rio de Janeiro', 'London', 'Paris'
];
const usStates = [
